        ...
        <div className="product__actions">
            ...
            {product.stock !== 'out-of-stock' && (
                <React.Fragment>
                    ...
                    <a className='btn btn-primary btn-lg btn-block' style={{background: '#3DDC55', color: 'white'}} href="https://wa.me/+971545747577"><span><img src='/images/whatsapp.svg' alt="whatsappicon" /></span>Check Avaliblity</a>
