...
function CheckoutForm() {
    ...
    const { ref: createAccountCheckboxRef, ...createAccountCheckboxProps } = register('createAccount');
    const { ref: shipToDifferentAddressCheckboxRef, ...shipToDifferentAddressCheckboxProps } = register('shipToDifferentAddress');
            ...
            <div className="form-group">
                    ...
                    <React.Fragment>
                        <div className="form-check">
                            <Checkbox
                                ...
                                inputRef={createAccountCheckboxRef}
                ...
                <div className="form-check">
                    <Checkbox
                        ...
                        inputRef={shipToDifferentAddressCheckboxRef}
                        {...shipToDifferentAddressCheckboxProps}
                    />
